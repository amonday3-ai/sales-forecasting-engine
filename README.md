...
[🚀 Launch the Live Demo](https://alex-sales-forecasting.streamlit.app/)
...
### [Launch the Sales Forecasting Engine →](https://alex-sales-forecasting.streamlit.app/)
...
1. separates recent history as a holdout period,
2. trains candidate models on the earlier observations,
3. forecasts the unseen holdout months,
4. compares those forecasts with actual historical values,
5. calculates WAPE,
6. and selects the strongest-performing approach.
...
[Live Demo](https://alex-sales-forecasting.streamlit.app/)  
[GitHub Repository](https://github.com/amonday3-ai/sales-forecasting-engine)
